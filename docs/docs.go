    ...
    "definitions": {
        ...
        "model.Todo": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "gorm.Model 대신 필요한 것만 직접 정의합니다.\n` + "`" + `gorm:\"primaryKey\"` + "`" + ` 태그로 이게 PK임을 알려줍니다.",
                    "type": "integer"
                },
                "task": {
                    "type": "string"
        ...
        "model.WebResponse": {
            ...
            "properties": {
                "code": {
                    "description": "결과 코드 (HTTP Status와 동일하게 쓰거나 커스텀 코드 사용)",
                    "type": "integer",
                    "example": 200
                },
                "data": {
                    "description": "실제 데이터 (Payload) - 무엇이든 들어갈 수 있음(Generic)"
                },
                "message": {
